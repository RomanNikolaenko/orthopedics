  ...
  new Swiper('.hero1__swiper', {
    ...
    pagination: {
      ...
      renderBullet: function (index, className) {
        return `<span class="${className}"><img src='${dotsImage[
          index
        ].trim()}' width='42' height='42' alt loading="lazy"> <span>${dotsName[
          index
        ].trim()}</span></span>`;
      },
    },
...
const ourDoctorSwiper = document.querySelector('.our-doctors__swiper');
if (ourDoctorSwiper) {
